...
@Component({
  ...
  styleUrls: ['./found-pet.component.css','./style.css']
})
export class FoundPetComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.authService.getAnimauxfoundList()
      .subscribe(data => {
       ...
       this.displayedItems = this.allanimauxfound.slice(0,3);
  ...
  //       this.allanimauxfound = data;
  //       // console.log(this.allanimauxfound);
  //       this.displayedItems = this.allanimauxfound;
  ...
  searchanimauxadd(): void {
    ...
    this.authService.getAnimauxfoundbyAddres(addrs)
      .subscribe(data => {
  ...
  searchanimauxBreed(): void {
    ...
    this.authService.getAnimauxfoundbyBreed(bred)
      .subscribe(data => {
  ...
  searchanimauxSize(): void {
    ...
    this.authService.getAnimauxfoundbySize(size)
      .subscribe(data => {
  ...
  searchanimauxAge(): void {
    ...
    this.authService.getAnimauxfoundbyAge(age)
      .subscribe(data => {
