...
@Component({
  ...
  styleUrls: ['./lost.component.css','./style.css']
})
export class LostComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.authService.getAnimauxlostbyid(this.idPet)
      .subscribe(data => {
        this.animauxlost = data;

        console.log(data.userlost);
        this.authService.getUserbyidanimaux(data.userlost)
          .subscribe(data => {
            this.users = data;
            this.users.id
    ...
    // this.authService.getFavoritesByUserIdAndAnimId(this.idu, this.idPet).subscribe(
    //   (response) => {
